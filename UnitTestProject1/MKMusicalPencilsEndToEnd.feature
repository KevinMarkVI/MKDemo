...
Scenario: End to End Musical Pencils Test Flow 1
	Given I am on the Miles Kimball homepage
	And I dismiss the Free Shipping popup
	And I click on Kids
	And I click on Pencils and Pencil Cases
...
Scenario: End to End Musical Pencils Test Flow 2
	Given I am on the Miles Kimball homepage
	And I dismiss the Free Shipping popup
	And I click on Kids
	And I click on Pencils and Pencil Cases
...
Scenario: End to End Musical Pencils Test Flow 3
	Given I am on the Miles Kimball homepage
	And I dismiss the Free Shipping popup
	And I click on Kids
	And I click on Pencils and Pencil Cases
...
Scenario: End to End Musical Pencils Test Flow 4
	Given I am on the Miles Kimball homepage
	And I dismiss the Free Shipping popup
	And I click on Kids
	And I click on Pencils and Pencil Cases
